...
Terdapat fitur **halaman publik** dan **halaman admin** untuk mengelola data project.
...
### 1. Clone repository
```bash
git clone https://github.com/USERNAME/flask-portfolio-app.git
